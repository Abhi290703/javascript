...
let item = prompt(("select options : 1) Briyani 2) Starter 3) Dessert"));
switch(item){
    case "Briyani":
        console.log("you have selected Briyani");
        break;
    case "Starter":
        console.log("you have selected Starter");
        break;      
    case "Dessert":
        console.log("you have selected Dessert");
        break;
}
...
This is all about condition statements in javascript
